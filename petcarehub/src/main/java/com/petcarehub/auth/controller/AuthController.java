...
import com.petcarehub.user.service.EmailService;
...
import com.petcarehub.user.repository.ForgotPasswordRepository;
import com.petcarehub.user.entity.ForgotPassword;
...
public class AuthController {
    ...
    public ResponseEntity<String> forgotPassword(@RequestBody Map<String, String> request) {
        ...
        return ResponseEntity
                .ok("If that email address is in our database, we will send an OTP to reset your password.");
    }
