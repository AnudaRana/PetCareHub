...
public class Pet {
    ...
    public String getKnownIllnesses() { return knownIllnesses; }
    public void setKnownIllnesses(String knownIllnesses) { this.knownIllnesses = knownIllnesses; }
    public String getPetImagePath() { return petImagePath; }
    public void setPetImagePath(String petImagePath) { this.petImagePath = petImagePath; }
