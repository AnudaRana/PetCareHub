...
const DoctorChanneling = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8083/api/appointments/booked-slots?date=${selectedDate}`)
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post('http://localhost:8083/api/appointments', appointmentData);

      const res = await axios.get(
        `http://localhost:8083/api/appointments/booked-slots?date=${selectedDate}`
      );
